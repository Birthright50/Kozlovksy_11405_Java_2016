...
public class ComplexMatrix2X2Test {
    ...
    private ComplexMatrix2X2 complexMatrix2X2WithZeroDet;

    @Before
    public void createSomeMatrix() {
        complexMatrix2X2 = (ComplexMatrix2X2) ac.getBean("com_matrix");
        complexMatrix2X2WithZeroDet = (ComplexMatrix2X2) ac.getBean("zero_com_matrix");
    ...
    public void threeConstructorsShouldBeEquals() {
        ComplexMatrix2X2 cm1 = (ComplexMatrix2X2) ac.getBean("default_matrix_2x2_with_no_arg");
        ComplexMatrix2X2 cm2 = (ComplexMatrix2X2) ac.getBean("default_matrix_2x2_with_1_arg");
        ComplexMatrix2X2 cm3 = (ComplexMatrix2X2) ac.getBean("default_matrix_2x2_with_4_arg");
