...
function JsSuggest(oHandler, sParams, sParser) {
    ...
    this.CheckModif = function (__data) {
        ...
        t.Send = function (sSearch) {
            ...
            CPHttpRequest.Send(TID, '/bitrix/components/bitrix/search.suggest.input/search.php', {
                "search": sSearch,
                "params": t.sParams
            });
        },
...
(function (a, e) {
    function d(b, c, h) {
        a.validity.registerReduction(b);
        var d = [];
        (b.reduction || b).filter(a.validity.settings.elementSupport).each(function () {
    ...
    function j(b, c) {
        g();
        a.validity.out.raise(a(b), c)
    }

    function k(b, c) {
        g();
        a.validity.out.raiseAggregate(b, c)
    }
    ...
    function i(b, a) {
        for (var h in a)a.hasOwnProperty(h) && (b = b.replace(RegExp("#\\{" + h + "\\}", "g"), a[h]));
        return o(b)
    }

    function p(b) {
        if (!a.validity.settings.useInfer)return a.validity.settings.defaultFieldName;
        var b = a(b), c = b.prop("id"), h = a.validity.settings.defaultFieldName;
        if (b.prop("title").length)h = b.prop("title"); else if (/^([A-Z0-9][a-z]*)+$/.test(c))h = c.replace(/([A-Z0-9])[a-z]*/g, " $&"); else if (/^[a-z0-9]+(_[a-z0-9]+)*$/.test(c)) {
            b = c.split("_");
            for (c = 0; c < b.length; ++c)b[c] = o(b[c]);
            h = b.join(" ")
        }
        return a.trim(h)
    }
    ...
    a.validity = {
        settings: a.extend({
            ...
            elementSupport: ":text, :password, textarea, select, :radio, :checkbox, input[type='hidden'], input[type='tel'], input[type='email'], input[type='number'], input[type='file']",
            argToString: function (b) {
                return b.getDate ?
                    [b.getMonth() + 1, b.getDate(), b.getFullYear()].join("/") : b + ""
            },
            debugPrivates: !1
        }, {}),
        patterns: {
        ...
        out: {
            ...
            }, raiseAggregate: function (b, a) {
                this.defer("raiseAggregate", b, a)
            }, defer: function (b) {
                var c = a.validity, c = c.outputs[c.settings.outputMode];
                c[b].apply(c, Array.prototype.slice.call(arguments, 1))
            }
        },
        ...
        setup: function (b) {
            ...
            this.__private = this.settings.debugPrivates ? q : e
        },
        report: null,
        ...
        start: function () {
            this.out.start();
            this.report = {errors: 0, valid: !0, reductionObjects: []}
        },
        end: function () {
            for (var b = this.report || {
                    errors: 0,
                    valid: !0
                }, a = 0; a < this.report.reductionObjects.length; ++a)delete this.report.reductionObjects[a].reduction;
            this.report = null;
            this.out.end(b);
            return b
        },
    ...
    a.fn.extend({
        validity: function (b) {
            return this.each(function () {
                ...
                if (this.tagName.toLowerCase() == "form") {
                    var h = null;
                    typeof b == "string" ? h = function () {
                        a(b).require()
                    } : a.isFunction(b) && (h = b);
                    b && a(this).bind("submit", function () {
                        a.validity.start();
                        h.apply(c);
                        return a.validity.end().valid
                    })
                }
            })
        }, require: function (b) {
            ...
            if (!c)c = a.validity.messages.match, typeof b === "string" && a.validity.messages[b] && (c = a.validity.messages[b]);
            typeof b ==
            "string" && (b = a.validity.patterns[b]);
            return d(this, a.isFunction(b) ? function (a) {
                return !a.value.length || b(a.value)
            } : function (a) {
                if (b.global)b.lastIndex = 0;
                return !a.value.length || b.test(a.value)
            }, c)
        }, range: function (b, c, h) {
            return d(this, b.getTime && c.getTime ? f(function (a) {
                a = new Date(a.value);
                return a >= new Date(b) && a <= new Date(c)
            }) : b.substring && c.substring && Big ? f(function (a) {
                a = new Big(a.value);
                return a.greaterThanOrEqualTo(new Big(b)) && a.lessThanOrEqualTo(new Big(c))
            }) : f(function (a) {
                a = parseFloat(a.value);
                return a >= b && a <= c
            }), h || i(a.validity.messages.range, {
                    min: a.validity.settings.argToString(b),
                    max: a.validity.settings.argToString(c)
                }))
        ...
        lessThanOrEqualTo: function (b, c) {
        ...
        }, alphabet: function (b, c) {
            var h = [];
            return d(this, function (a) {
                for (var c = 0; c < a.value.length; ++c)if (b.indexOf(a.value.charAt(c)) == -1)return h.push(a.value.charAt(c)), !1;
                return !0
            }, c || i(a.validity.messages.alphabet, {chars: h.join(", ")}))
        }, minCharClass: function (b, c, h) {
            typeof b == "string" && (b = b.toLowerCase(), a.validity.charClasses[b] && (b = a.validity.charClasses[b]));
            return d(this, f(function (a) {
                return (a.value.match(b) || []).length >= c
            }), h || i(a.validity.messages.minCharClass,
                    {min: c, charClass: b}))
        }, maxCharClass: function (b, c, h) {
            typeof b == "string" && (b = b.toLowerCase(), a.validity.charClasses[b] && (b = a.validity.charClasses[b]));
            return d(this, function (a) {
                return (a.value.match(b) || []).length <= c
            ...
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport),
                e = function (a) {
                    return a
                }, g = a.validity.messages.equal;
            if (d.length) {
                a.isFunction(b) ? (e = b, typeof c == "string" && (g = c)) : typeof b == "string" && (g = b);
                var f = a.map(d, function (a) {
                    return e(a.value)
                }), i = f[0], j = !0, m;
                for (m in f)f[m] != i && (j = !1);
                if (!j)k(d, g), this.reduction = a([])
            }
            return this
        }, distinct: function (b, c) {
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport), e = function (a) {
                return a
            }, g = a.validity.messages.distinct, f = [], i = [], j = !0;
            if (d.length) {
                a.isFunction(b) ?
                    (e = b, typeof c == "string" && (g = c)) : typeof b == "string" && (g = b);
                for (var m = a.map(d, function (a) {
                    return e(a.value)
                }), n = 0; n < m.length; ++n)if (m[n].length) {
                    for (var l = 0; l < f.length; ++l)f[l] == m[n] && (j = !1, i.push(m[n]));
                    f.push(m[n])
                }
                if (!j) {
                    i = a.unique(i);
                    f = 0;
                    for (j = i.length; f < j; ++f)k(d.filter("[value='" + i[f] + "']"), g);
                    this.reduction = a([])
                }
            }
            return this
            ...
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport);
            if (d.length && b != l(d))k(d, c || i(a.validity.messages.sum,
                    {sum: b})), this.reduction = a([]);
            return this
        }, sumMax: function (b, c) {
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport);
            if (d.length && b < l(d))k(d, c || i(a.validity.messages.sumMax, {max: b})), this.reduction = a([]);
            return this
        }, sumMin: function (b, c) {
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport);
            if (d.length && b > l(d))k(d, c || i(a.validity.messages.sumMin, {min: b})), this.reduction = a([]);
            return this
        }, radioChecked: function (b,
                                   c) {
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport);
            d.is(":radio") && d.find(":checked").val() != b && k(d, c || a.validity.messages.radioChecked)
        }, radioNotChecked: function (b, c) {
            a.validity.registerReduction(this);
            var d = (this.reduction || this).filter(a.validity.settings.elementSupport);
            d.is(":radio") && d.filter(":checked").val() == b && k(d, c || a.validity.messages.radioChecked)
        }, checkboxChecked: function (b) {
            return d(this, function (b) {
                return !a(b).is(":checkbox") ||
                    a(b).is(":checked")
            }, b || a.validity.messages.checkboxChecked)
        }, assert: function (b, c) {
            a.validity.registerReduction(this);
            var e = this.reduction || this;
            if (e.length)if (a.isFunction(b))return d(this, b, c || a.validity.messages.generic); else if (!b)k(e, c || a.validity.messages.generic), this.reduction = a([]);
            return this
        }, fail: function (a) {
...
(function (a) {
    a.validity.outputs.tooltip = {
        tooltipClass: "validity-tooltip", start: function () {
            ...
            g.left += e.width() + 18;
            g.top += 8;
            var j = a('<div class="validity-tooltip">' + d + '<div class="validity-tooltip-outer"><div class="validity-tooltip-inner"></div></div></div>').click(function () {
                e.focus();
                a(this).fadeOut()
            }).css(g).hide().appendTo("body").fadeIn();
            if (a.validity.settings.fadeOutTooltipsOnFocus)e.on("focus", function () {
                j.fadeOut()
            })
...
(function (a) {
    ...
    a.validity.outputs.label = {
        cssClass: "error", start: function () {
            ...
            var j = "." + a.validity.outputs.label.cssClass + "[for='" + e(d) + "']";
            if (a(j).length)a(j).text(g); else {
                var j =
                    a("<label/>").attr("for", e(d)).addClass(a.validity.outputs.label.cssClass).text(g).click(function () {
                        d.length && d[0].select()
                    }), k = d;
                d.is(":checkbox") && a("label[for='" + e(d) + "']").length && (k = a("label[for='" + e(d) + "']"));
                j.insertAfter(k)
            }
        }, raiseAggregate: function (d, e) {
            d.length && this.raise(a(d.get(d.length - 1)), e)
        }
    }
})(jQuery);
(function (a) {
    a.validity.outputs.modal = {
        start: function () {
            ...
            if (e.length) {
                var g = e.offset();
                e.get(0);
                g = {left: parseInt(g.left + e.width() + 4, 10) + "px", top: parseInt(g.top - 10, 10) + "px"};
                a("<div/>").addClass("validity-modal-msg").css(g).text(d).click(a.validity.settings.modalErrorsClickable ? function () {
                    a(this).remove()
                } : null).appendTo("body")
            }
        },
...
(function (a) {
    var e = [];
    a.validity.outputs.summary = {
        options: {container: ".validity-summary-container"}, start: function () {
            a(".validity-erroneous").removeClass("validity-erroneous");
            e = []
        }, end: function () {
            a(this.options.container).stop().hide().find("ul").html("");
            if (e.length) {
                for (var d = 0; d < e.length; ++d)a("<li/>").text(e[d]).appendTo(this.options.container + " ul");
                a(this.options.container).show();
                if (a.validity.settings.scrollTo)location.hash = a(".validity-erroneous:eq(0)").attr("id")
            }
        }, raise: function (a, g) {
            e.push(g);
            a.addClass("validity-erroneous")
        }, raiseAggregate: function (a, e) {
            this.raise(a, e)
        }, container: function () {
...
( function ($) {
    ...
    $.fn.darkbox = function () {
        ...
        $('<div class="darkbox"><div class="darkbox-shadow"></div><div class="darkbox-canvas"><img alt=""><div class="darkbox-button" title="Close"></div></div></div>').appendTo('body');
        ...
        function openBox(e) {
            ...
            darkboxImage.one('error', handleImageLoadError).css({
                'width': '',
                'height': ''
            }).attr('src', link.attr('href')).attr('alt', link.attr('title'));
        ...
        function closeBox() {
            ...
            darkboxShadow.animate(
                ...
                function () {
                    ...
                    darkboxImage.unbind('error', handleImageLoadError).attr('src', ''); // FIXME: Fires error in IE - check
                }
            );
        }
        ...
        // Darkbox handlers
        darkboxShadow.css({opacity: 0}).click(closeBox);

        darkboxButton.addClass(buttonPlaceClass).click(closeBox);
        ...
        $(document).keypress(handleKey).keydown(handleKey);
